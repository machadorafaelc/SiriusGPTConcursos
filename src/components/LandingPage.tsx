...
import { Brain, BookOpen, Target, Users, Zap, TrendingUp } from 'lucide-react';
...
export function LandingPage() {
  const features = [
    ...
    },
    {
      icon: Users,
      title: "Comunidade",
      description: "Conecte-se com outros candidatos e compartilhe experiências"
    },
    {
      icon: Zap,
  ...
  return (
    <div className="relative min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-950 to-purple-950 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-7xl mb-6 bg-gradient-to-r from-blue-300 via-purple-400 to-pink-400 bg-clip-text text-transparent">
              Um Universo de
              <br />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="bg-slate-900/50 border-blue-800/30 backdrop-blur-sm hover:bg-slate-900/70 transition-all duration-300">
                <CardHeader>
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-lg flex items-center justify-center mb-4">
      ...
      <section className="py-20 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <Card className="relative bg-slate-900/80 border-blue-800/30 backdrop-blur-sm">
              <CardHeader>
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {[
                    ...
                    <div 
                      key={index}
                      className="bg-slate-800/50 border border-blue-700/30 rounded-lg p-3 hover:bg-slate-800/70 hover:border-blue-600/50 transition-colors cursor-pointer"
                    >
